...
# # Title
# st.title("Python Lesson 01 - MCQs Quiz")

# # Store MCQs as a list of dictionaries
# mcqs = [
#     {
...
# # Display question
# st.subheader(f"Question {q_idx + 1} of {len(mcqs)}")
# user_answer = st.radio(mcq['question'], mcq['options'], key=q_idx)
# st.session_state.answers[q_idx] = user_answer

# # Next button
# if st.button("Next"):
#     if user_answer == mcq['answer']:
#         if st.session_state.answers[q_idx] != mcq['answer']:
...
#     else:
#         st.success(f"Quiz Completed! You scored {st.session_state.score} out of {len(mcqs)}")
#         st.stop()
